...
private:
    ...
    void createSwapChain() {
        SwapChainSupportDetails swapChainSupport = init.querySwapChainSupport(m_physicalDevice);
        ...
        QueueFamilyIndices indices = init.findQueueFamilies(m_physicalDevice);
